  ...
  <h3>Name</h3>
    ...
    <br>
		...
		<label>Year of Completion:</label>
			<input type="text" name="beyear" size="30" maxlength="4" value=""/><br><br>

    <label>Degree:</label>
			<input type="text" name="beyear" size="30" maxlength="150" value=""/><br>
			</li><br>
      ...
      <label>Start Date</label>
        <input type="date" name="sjobdate1" maxlength="10" value=""/><br>
      <label>End Date</label>
        <input type="date" name="ejobdate1" maxlength="10" value=""/><br>
			<label>Job Description</label><br> 
				<textarea name="job1description" maxlength="10000" value=""></textarea><br>
      <br>
    <label>Job Title</label>
      <span>
      ...
      <label>End Date</label>
        <input type="date" name="ejobdate2" maxlength="10" value=""/><br>
			<label>Job Description</label><br> 
				<textarea name="job2description" maxlength="10000" value=""></textarea><br>
      <br>
    <label>Job Title</label>
      <span>
      ...
      <label>End Date</label>
        <input type="date" name="ejobdate3" maxlength="10" value=""/><br>
			<label>Job Description</label><br> 
				<textarea name="job3description" maxlength="10000" value=""></textarea><br>	
      <br>
    <label>Job Title</label>
      <span>
